...
function publish_container() {
	...
	writeLog "INFO" "Publishing OCI image ${IMAGE_NAME}:${IMAGE_TAG} to registry ${REGISTRY_PATH}"
	...
	if [[ ${IMAGE_TAG} != "latest" ]]; then
		...
		writeLog "INFO" "Publishing OCI image ${IMAGE_NAME}:latest to registry ${REGISTRY_PATH}"

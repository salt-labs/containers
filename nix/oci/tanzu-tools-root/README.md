...
| TANZU_TOOLS_ENABLE_PINNIPED          | Enable in Pinniped environments to login on startup                                     |  FALSE  | TRUE, FALSE                                                             |
...
| TANZU_TOOLS_SYNC_PLUGINS             | Enable to run 'tanzu plugin sync' on launch                                             |  FALSE  | TRUE, FALSE                                                             |
| TANZU_TOOLS_SYNC_VENDOR              | Enable to run 'vendir sync' on launch                                                   |  FALSE  | TRUE, FALSE                                                             |
